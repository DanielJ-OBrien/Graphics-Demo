...
void TCubeNode::Render()
{
	...
	constantBuffer.AmbientLightColour = (this->_colour);
	constantBuffer.DirectionalLightVector = Vector4(-1.0f, -1.0f, 1.0f, 0.0f);
	constantBuffer.DirectionalLightColour = Vector4(0.5f, 0.5f, 0.5f, 0.5f);
...
void TCubeNode::BuildGeometryBuffers()
{
...
void TCubeNode::BuildConstantBuffer()
{
...
void TCubeNode::BuildRasteriserState()
